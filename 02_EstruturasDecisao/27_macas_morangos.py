# Entrada de dados
totalMorangos = float(raw_input('Informe a quantidade (em Kg) de morangos comprados: '))
totalMacas = float(raw_input('Informe a quantidade (em Kg) de macas comprados: '))
