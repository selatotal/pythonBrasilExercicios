...
for i in range(0, len(usuarios)):
	...
	arquivoSaida.write('\n%d - %s - %.2f MB - %.2f%%' % (i+1, usuarios[i], espacoMB, percentualUso*100.0))

arquivoSaida.write('\nEspaco total ocupado: %.2f MB' % (espacoTotal/(1024.0*1024.0)))
arquivoSaida.write('\nEspaco medio ocupado: %.2f MB' % (espacoTotal / len(usuarios) / (1024.0*1024.0)))
