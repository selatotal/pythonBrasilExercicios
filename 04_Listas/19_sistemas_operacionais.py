...
maiorVoto = 0
for sistema in sistemasOperacionais:
	print '%-21s %5d   %2.2f' % (sistemasOperacionais[i], votosSistemas[i], votosSistemas[i] / float(totalVotos) * 100)
...
print 'O sistema operacional mais votado foi o %s, com %d, correspondendo a %.2f%% dos votos.' % (sistemasOperacionais[maiorVoto], votosSistemas[maiorVoto], votosSistemas[maiorVoto] / float(totalVotos) * 100)